...
docker run -d --name mongo --network composer_default -p 27017:27017 -v /home/amenda/Desktop/Hyperledger/distributor-network-2/fabric-tools/fabric-scripts/hlfv11/composer/mongo:/data/db mongo
...
composer-rest-server -c admin@distributor-network -n never -w true -m true
